...
export const roadTile7 = () => {
  return [
    createDummyTile("2", ["r", "c", "r", "r"], "e"),
    createDummyTile("3", ["r", "f", "r", "f"], "r"),
    createDummyTile("4", ["r", "f", "f", "r"], "r"),
    createDummyTile("5", ["f", "r", "r", "f"], "r"),
    createDummyTile("6", ["r", "r", "c", "f"], "r"),
...
export const roadTile9 = () => {
  return [
    createDummyTile("2", ["r", "f", "r", "f"], "r"),
    createDummyTile("3", ["r", "f", "r", "r"], "e"),
    createDummyTile("4", ["r", "f", "r", "r"], "e"),
  ];
};

export const endGameTile1 = () => {
  return [
    createDummyTile("3", ["f", "f", "f", "f"], "m"),
    createDummyTile("4", ["r", "f", "r", "f"], "r"),
    createDummyTile("5", ["f", "f", "c", "f"], "f"),
    createDummyTile("6", ["f", "f", "f", "c"], "f"),
  ];
};
